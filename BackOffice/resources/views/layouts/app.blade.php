                ...
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/dashboard') }}">
                    <div class="logo_laravel">
                        ...
                        <svg width="100" height="100" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" fill="none">
                            <circle cx="100" cy="100" r="90" fill="#1E90FF" stroke="#8A2BE2" stroke-width="10"/>
                            <path d="M70 70 L130 50 L130 140 Q110 130 90 140 T70 140 Z" fill="#FF1493" stroke="#2C2C2C" stroke-width="5"/>
                            {{-- <text x="50" y="175" font-family="Arial, sans-serif" font-size="24" fill="#F5F5F5" font-weight="bold">Music Hub</text> --}}
                        </svg>
